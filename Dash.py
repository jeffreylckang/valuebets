 ...
 "cells": [
  {
   ...
   "outputs": [
    {
     "data": {
      "text/html": [
       "<pre style=\"white-space:pre;overflow-x:auto;line-height:normal;font-family:Menlo,'DejaVu Sans Mono',consolas,'Courier New',monospace\"><span style=\"color: #7fbfbf; text-decoration-color: #7fbfbf\">[01/08/25 13:09:19] </span><span style=\"color: #000080; text-decoration-color: #000080\">INFO    </span> No custom team name replacements found. You can configure these in       <a href=\"file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_config.py\" target=\"_blank\"><span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\">_config.py</span></a><span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\">:</span><a href=\"file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_config.py#90\" target=\"_blank\"><span style=\"color: #7f7f7f; text-decoration-color: #7f7f7f\">90</span></a>\n",
      ...
      "text/plain": [
       "\u001b[2;36m[01/08/25 13:09:19]\u001b[0m\u001b[2;36m \u001b[0m\u001b[34mINFO    \u001b[0m No custom team name replacements found. You can configure these in       \u001b]8;id=365428;file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_config.py\u001b\\\u001b[2m_config.py\u001b[0m\u001b]8;;\u001b\\\u001b[2m:\u001b[0m\u001b]8;id=303080;file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_config.py#90\u001b\\\u001b[2m90\u001b[0m\u001b]8;;\u001b\\\n",
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "\u001b[2;36m                   \u001b[0m\u001b[2;36m \u001b[0m\u001b[34mINFO    \u001b[0m No custom league dict found. You can configure additional leagues in    \u001b]8;id=727645;file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_config.py\u001b\\\u001b[2m_config.py\u001b[0m\u001b]8;;\u001b\\\u001b[2m:\u001b[0m\u001b]8;id=858419;file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_config.py#196\u001b\\\u001b[2m196\u001b[0m\u001b]8;;\u001b\\\n",
    ...
    },
    {
     "data": {
      ...
      "text/plain": [
       "\u001b[2;36m                   \u001b[0m\u001b[2;36m \u001b[0m\u001b[34mINFO    \u001b[0m Saving cached data to \u001b[35m/Users/jeffreykang/soccerdata/data/\u001b[0m\u001b[95mFBref\u001b[0m          \u001b]8;id=501373;file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_common.py\u001b\\\u001b[2m_common.py\u001b[0m\u001b]8;;\u001b\\\u001b[2m:\u001b[0m\u001b]8;id=557955;file:///opt/anaconda3/lib/python3.12/site-packages/soccerdata/_common.py#263\u001b\\\u001b[2m263\u001b[0m\u001b]8;;\u001b\\\n"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
   ...
   "source": [
    ...
    "            home_streaks, away_streaks = epl_analyze_team_streaks(home_team), epl_analyze_team_streaks(away_team)\n",
  ...
  },
  {
   ...
   "source": [
    "def scale_features(features_dict, home_team, away_team, home_odds, away_odds, loaded_params, game_features, sport_id):\n",
    "    try:\n",
    "        print(\"Starting scale_features function\")\n",
    "\n",
    "        # Elo ratings dictionaries\n",
    "        elo_ratings = {\n",
    "            1: nba_elo_ratings,\n",
    ...
    "        scaled_avg_odds_ratio = (odds_ratio - mean_avg_odds_ratio) / std_avg_odds_ratio\n",
    "\n",
    "        print(\"Scaled odds and odds ratio successfully\")\n",
    "\n",
    "        # Initialize streaks to defaults\n",
    "        hteam_w_streak, hteam_l_streak, ateam_w_streak, ateam_l_streak = 0, 0, 0, 0\n",
    "\n",
    ...
    "        away_team_elo = elo_ratings.get(sport_id, {}).get(away_team, 1500)\n",
    "        elo_diff = home_team_elo - away_team_elo\n",
    "        elo_discrepancy = pd.cut([elo_diff], bins=[-float('inf'), -50, 50, float('inf')], labels=[-1, 0, 1])[0]\n",
    "        elo_discrepancy = int(elo_discrepancy)\n",
    "\n",
    "        home_favored_by_odds = int(home_odds < away_odds)\n",
    "        home_favored_by_elo = int(home_team_elo > away_team_elo)\n",
    "        away_favored_by_odds = int(home_odds > away_odds)\n",
    ...
    "        unscaled_features = [\n",
    "            hteam_w_streak, hteam_l_streak, ateam_w_streak, ateam_l_streak,\n",
    "            features_dict['home_wr_favored'].get(home_team, 0),\n",
    "            features_dict['away_wr_favored'].get(away_team, 0),\n",
    "            features_dict['home_wr_underdog'].get(home_team, 0),\n",
    "            features_dict['away_wr_underdog'].get(away_team, 0),\n",
    "            features_dict['home_team_upset'].get(home_team, 0),\n",
    "            features_dict['away_team_upset'].get(away_team, 0),\n",
    "            home_team_elo, away_team_elo, elo_diff, elo_discrepancy, home_odds_elo_mismatch, away_odds_elo_mismatch\n",
    "        ]\n",
    "\n",
    "        print(\"Unscaled features prepared:\", unscaled_features)\n",
    "        print(\"Length of unscaled features:\", len(unscaled_features))\n",
    "        print(\"Expected scaler mean/std length:\", len(loaded_params['means'][3:]))\n",
    "\n",
    "        # Scale these features\n",
    "        scaler = StandardScaler()\n",
    "        scaler.mean_ = np.array(loaded_params['means'][3:])\n",
    ...
    "\n",
    "    except Exception as e:\n",
    "        print(\"Error in scale_features:\", e)\n",
    "        raise\n",
    "\n",
    "features_dict = {\n",
    "    'home_wr_favored': {'Golden State Warriors': 0.6, 'Miami Heat': 0.4},\n",
    "    'away_wr_favored': {'Golden State Warriors': 0.4, 'Miami Heat': 0.6},\n",
    "    'home_wr_underdog': {'Golden State Warriors': 0.5, 'Miami Heat': 0.3},\n",
    "    'away_wr_underdog': {'Golden State Warriors': 0.3, 'Miami Heat': 0.5},\n",
    "    'home_team_upset': {'Golden State Warriors': 0.1, 'Miami Heat': 0.2},\n",
    "    'away_team_upset': {'Golden State Warriors': 0.2, 'Miami Heat': 0.1}}\n",
    "loaded_params = {\n",
    "    'means': [1.5, 1.5, 1.0] + [0.5] * 10,\n",
    "    'stds': [0.5, 0.5, 0.1] + [0.1] * 10}\n",
    "nba_elo_ratings = {'Golden State Warriors': 1600, 'Miami Heat': 1500}\n",
    "nfl_elo_ratings = {'Golden State Warriors': 1500, 'Miami Heat': 1600}\n",
    "epl_elo_ratings = {'Golden State Warriors': 1500, 'Miami Heat': 1600}\n",
    "\n",
   ...
   "outputs": [
    {
     "data": {
      ...
      "text/plain": [
       "<IPython.lib.display.IFrame at 0x176a8ff50>"
      ]
     },
     "metadata": {},
     "output_type": "display_data"
    },
    {
     ...
     "output_type": "stream",
     "text": [
      "/var/folders/zh/zpq1jwf12yxfl2w27y1pd6vr0000gn/T/ipykernel_82699/2090878289.py:364: UserWarning:\n",
      "\n",
  ...
  },
  {
   "cell_type": "code",
   "execution_count": null,
   "id": "4c000fee-d052-428f-8a50-c9db46584098",
   "metadata": {},
   "outputs": [],
   "source": []
  }
